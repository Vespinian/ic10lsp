...
pub(crate) const INSTRUCTIONS: phf::Map<&'static str, InstructionSignature> = phf_map! {
    ...
    "sb" => InstructionSignature(&[DEVICE, LOGIC_TYPE, VALUE]),
    "sbn" => InstructionSignature(&[DEVICE, NAME_HASH, LOGIC_TYPE, VALUE]),
    "sbs" => InstructionSignature(&[DEVICE, SLOT_INDEX, SLOT_LOGIC_TYPE, VALUE]),
