...
impl Display for InstructionSignature {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        for parameter in self.0 {
            let param_str = parameter.to_string();
            write!(f, " {param_str}")?;
        }
        Ok(())
    }
...
11: Purple
    ...
    "RatioHelium" => "The ratio of Helium in device's Atmosphere",
    "RatioHeliumInput" => "The ratio of Helium in device's Input Atmosphere",
    "RatioHeliumInput2" => "The ratio of Helium in device's Input2 Atmosphere",
    "RatioHeliumOutput" => "The ratio of Helium in device's Output Atmosphere",
    "RatioHeliumOutput2" => "The ratio of Helium in device's Output2 Atmosphere",
    "RatioHydrazine" => "The ratio of Hydrazine in device's Atmosphere",
    "RatioHydrazineInput" => "The ratio of Hydrazine in device's Input Atmosphere",
    "RatioHydrazineInput2" => "The ratio of Hydrazine in device's Input2 Atmosphere",
    "RatioHydrazineOutput" => "The ratio of Hydrazine in device's Output Atmosphere",
    "RatioHydrazineOutput2" => "The ratio of Hydrazine in device's Output2 Atmosphere",
    "RatioHydrochloricAcid" => "The ratio of Hydrochloric Acid in device's Atmosphere",
    "RatioHydrochloricAcidInput" => "The ratio of Hydrochloric Acid in device's Input Atmosphere",
    "RatioHydrochloricAcidInput2" => "The ratio of Hydrochloric Acid in device's Input2 Atmosphere",
    "RatioHydrochloricAcidOutput" => "The ratio of Hydrochloric Acid in device's Output Atmosphere",
    "RatioHydrochloricAcidOutput2" => "The ratio of Hydrochloric Acid in device's Output2 Atmosphere",
    "RatioHydrogen" => "The ratio of Hydrogen in device's Atmopshere",
    "RatioHydrogenInput" => "The ratio of Hydrogen in device's Input Atmosphere",
    "RatioHydrogenInput2" => "The ratio of Hydrogen in device's Input2 Atmosphere",
    "RatioHydrogenOutput" => "The ratio of Hydrogen in device's Output Atmosphere",
    "RatioHydrogenOutput2" => "The ratio of Hydrogen in device's Output2 Atmosphere",
    "RatioLiquidAlcohol" => "The ratio of Liquid Alcohol in device's Atmosphere",
    "RatioLiquidAlcoholInput" => "The ratio of Liquid Alcohol in device's Input Atmosphere",
    "RatioLiquidAlcoholInput2" => "The ratio of Liquid Alcohol in device's Input2 Atmosphere",
    "RatioLiquidAlcoholOutput" => "The ratio of Liquid Alcohol in device's Output Atmosphere",
    "RatioLiquidAlcoholOutput2" => "The ratio of Liquid Alcohol in device's Output2 Atmosphere",
    ...
    "RatioLiquidHydrazine" => "The ratio of Liquid Hydrazine in device's Atmosphere",
    "RatioLiquidHydrazineInput" => "The ratio of Liquid Hydrazine in device's Input Atmosphere",
    "RatioLiquidHydrazineInput2" => "The ratio of Liquid Hydrazine in device's Input2 Atmosphere",
    "RatioLiquidHydrazineOutput" => "The ratio of Liquid Hydrazine in device's Output Atmosphere",
    "RatioLiquidHydrazineOutput2" => "The ratio of Liquid Hydrazine in device's Output2 Atmosphere",
    "RatioLiquidHydrochloricAcid" => "The ratio of Liquid Hydrochloric Acid in device's Atmosphere",
    "RatioLiquidHydrochloricAcidInput" => "The ratio of Liquid Hydrochloric Acid in device's Input Atmosphere",
    "RatioLiquidHydrochloricAcidInput2" => "The ratio of Liquid Hydrochloric Acid in device's Input2 Atmosphere",
    "RatioLiquidHydrochloricAcidOutput" => "The ratio of Liquid Hydrochloric Acid in device's Output Atmosphere",
    "RatioLiquidHydrochloricAcidOutput2" => "The ratio of Liquid Hydrochloric Acid in device's Output2 Atmosphere",
    "RatioLiquidHydrogen" => "The ratio of Liquid Hydrogen in device's Atmopshere",
    "RatioLiquidHydrogenInput" => "The ratio of Liquid Hydrogen in device's Input Atmosphere",
    "RatioLiquidHydrogenInput2" => "The ratio of Liquid Hydrogen in device's Input2 Atmosphere",
    "RatioLiquidHydrogenOutput" => "The ratio of Liquid Hydrogen in device's Output Atmosphere",
    "RatioLiquidHydrogenOutput2" => "The ratio of Liquid Hydrogen in device's Output2 Atmosphere",
    "RatioLiquidMethane" => "The ratio of Liquid Methane in device's Atmosphere",
    "RatioLiquidMethaneInput" => "The ratio of Liquid Methane in device's Input Atmosphere",
    "RatioLiquidMethaneInput2" => "The ratio of Liquid Methane in device's Input2 Atmosphere",
    "RatioLiquidMethaneOutput" => "The ratio of Liquid Methane in device's device's Output Atmosphere",
    "RatioLiquidMethaneOutput2" => "The ratio of Liquid Methane in device's Output2 Atmopshere",
    ...
    "RatioLiquidOzone" => "The ratio of Liquid Ozone in device's Atmosphere",
    "RatioLiquidOzoneInput" => "The ratio of Liquid Ozone in device's Input Atmosphere",
    "RatioLiquidOzoneInput2" => "The ratio of Liquid Ozone in device's Input2 Atmosphere",
    "RatioLiquidOzoneOutput" => "The ratio of Liquid Ozone in device's Output Atmosphere",
    "RatioLiquidOzoneOutput2" => "The ratio of Liquid Ozone in device's Output2 Atmosphere",
    ...
    "RatioLiquidSilanol" => "The ratio of Liquid Silanol in device's Atmosphere",
    "RatioLiquidSilanolInput" => "The ratio of Liquid Silanol in device's Input Atmosphere",
    "RatioLiquidSilanolInput2" => "The ratio of Liquid Silanol in device's Input2 Atmosphere",
    "RatioLiquidSilanolOutput" => "The ratio of Liquid Silanol in device's Output Atmosphere",
    "RatioLiquidSilanolOutput2" => "The ratio of Liquid Silanol in device's Output2 Atmosphere",
    "RatioLiquidSodiumChloride" => "The ratio of Liquid Sodium Chloride in device's Atmosphere",
    "RatioLiquidSodiumChlorideInput" => "The ratio of Liquid Sodium Chloride in device's Input Atmosphere",
    "RatioLiquidSodiumChlorideInput2" => "The ratio of Liquid Sodium Chloride in device's Input2 Atmosphere",
    "RatioLiquidSodiumChlorideOutput" => "The ratio of Liquid Sodium Chloride in device's Output Atmosphere",
    "RatioLiquidSodiumChlorideOutput2" => "The ratio of Liquid Sodium Chloride in device's Output2 Atmosphere",
    "RatioMethane" => "The ratio of Methane in device atmosphere",
    "RatioMethaneInput" => "The ratio of Methane in device's input network",
    "RatioMethaneInput2" => "The ratio of Methane in device's Input2 network",
    "RatioMethaneOutput" => "The ratio of Methane in device's Output network",
    "RatioMethaneOutput2" => "The ratio of Methane in device's Output2 network",
    ...
    "RatioOzone" => "The ratio of Ozone in device's Atmosphere",
    "RatioOzoneInput" => "The ratio of Ozone in device's Input Atmosphere",
    "RatioOzoneInput2" => "The ratio of Ozone in device's Input2 Atmosphere",
    "RatioOzoneOutput" => "The ratio of Ozone in device's Output Atmosphere",
    "RatioOzoneOutput2" => "The ratio of Ozone in device's Output2 Atmosphere",
    ...
    "RatioPollutedWaterInput" => "The ratio of Polluted Water in device's Input Atmosphere",
    "RatioPollutedWaterInput2" => "The ratio of Polluted Water in device's Input2 Atmosphere",
    "RatioPollutedWaterOutput" => "The ratio of Polluted Water in device's Output Atmosphere",
    "RatioPollutedWaterOutput2" => "The ratio of Polluted Water in device's Output2 Atmosphere",
    "RatioSilanol" => "The ratio of Silanol in device's Atmosphere",
    "RatioSilanolInput" => "The ratio of Silanol in device's Input Atmosphere",
    "RatioSilanolInput2" => "The ratio of Silanol in device's Input2 Atmosphere",
    "RatioSilanolOutput" => "The ratio of Silanol in device's Output Atmosphere",
    "RatioSilanolOutput2" => "The ratio of Silanol in device's Output2 Atmosphere",
